...
field_namen = ['Email', 'Telefon', 'Adresse', 'Funktion', 'Arbeitskreise', 'Geburtsdatum', 'Schuleintritt', 'Klasse', 'Pinnwand']
klassen_namen = ['p1', 'p2', 'sek', 'kiga']
nur_schule_klassen_namen = ['p1', 'p2', 'sek']
...
print('# Kolibri Klassen autogenerated on '+now)
for klasse in klassen_namen:
...
print('# Kolibri Eltern autogenerated on '+now)
print('eltern@'+domain+' ',end='')
for e in sorted(eltern_emails_set):
    print(e+' ',end='')
print();print()

print('# Alle autogenerated on '+now)
print('alle@'+domain+' ',end='')
for e in sorted(alle_emails_set):
    print(e+' ',end='')
print();print()

print('# Kolibri teams autogenerated on '+now)
...
print('# Kolibri Arbeitskreise autogenerated on '+now)
for ak in ak_namen:
...
print('# Kolibri Pinnwand autogenerated on '+now)
print('pinnwand@'+domain+' ', end='')
for e in sorted(pinnwand_emails):
    print(e+' ',end='')
print();print()

print('# Kolibri local emails autogenerated on '+now)
for e in sorted(alle_emails_set):
    email_split=e.split('@')
